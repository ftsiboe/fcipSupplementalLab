...
**fcipSupplementalLab** is a research framework for analyzing supplemental crop
insurance products within the United States **Federal Crop Insurance Program (FCIP)**.

The repository supports reproducible, policy-oriented analysis of how supplemental
coverage options affect producer behavior, actuarial performance, public–private
risk sharing, and federal fiscal exposure.
